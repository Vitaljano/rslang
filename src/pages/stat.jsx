...
function Stat() {
  ...
  return (
    <>
      <Header />
      <div className="container mx-auto flex flex-col justify-center md:flex-row py-10">
        <div className="p-4 h-64  rounded-2xl md:border border-borderGray md:shadow-xl">
        ...
        <div className="w-full">
          <h2 className="text-center font-medium text-2xl mb-4">Статистика</h2>
