...
function Header() {
  return (
    <header className="bg-header max-w-1400px w-full h-20 text-white">
      <div className="container h-full items-center my-0 mx-auto w-11/12 flex justify-between ">
        ...
        <div className="actions flex items-center flex-row">
          <button
            type="button"
            className="text-white text-xl border-2 border-bg-white font-medium rounded-lg w-48 h-12 hover:bg-white hover:text-action hover:border-none transition duration-300 ease-in-out ml-4"
          >
            Начать учиться
          </button>
          <div className="burger ml-8 cursor-pointer">
            <svg
              x="0px"
              y="0px"
              viewBox="0 0 512 512"
